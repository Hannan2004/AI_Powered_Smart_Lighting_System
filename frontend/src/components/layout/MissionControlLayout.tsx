...
const MissionControlLayout: React.FC<MissionControlLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-[#0a1628]">
      {/* Left Sidebar */}
      <aside className="w-64 bg-[#0d1b2e] border-r border-gray-800 flex flex-col">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <div className="flex items-center gap-1.5 ml-auto">
              <div className={`w-2 h-2 rounded-full animate-pulse ${
                systemStatus === 'OPERATIONAL' ? 'bg-green-500' : systemStatus === 'WARNING' ? 'bg-yellow-500' : 'bg-red-500'
              }`} />
              <span className={`text-xs font-medium ${
                systemStatus === 'OPERATIONAL' ? 'text-green-500' : systemStatus === 'WARNING' ? 'text-yellow-400' : 'text-red-400'
              }`}>
                {systemStatus}
              </span>
            </div>
            ...
            {(
              ...
              <button
                ...
                className={`text-[10px] px-2 py-1 rounded border transition-colors ${
                  systemStatus === m.id ? m.cls + ' bg-white/5' : 'text-gray-400 border-gray-700 hover:bg-gray-800'
                }`}
                title={`Set ${m.label}`}
              >
                {m.label}
                  ...
                  <div className="mt-3 ml-4 space-y-2 border-l-2 border-pink-500/30 pl-4">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="downtown">Downtown Sector</option>
                        <option value="midtown">Midtown Sector</option>
                ...
                {section.id === 'power' && isExpanded && (
                  <div className="mt-3 ml-4 space-y-2 border-l-2 border-orange-500/30 pl-4">
                    ...
                    <button
                      ...
                      className={`w-full px-3 py-2 text-xs rounded transition-colors ${
                        blackoutScenario === 'weather-catastrophe'
                    ...
                    <button
                      ...
                      className={`w-full px-3 py-2 text-xs rounded transition-colors ${
                        blackoutScenario === 'equipment-minor'
